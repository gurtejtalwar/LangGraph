import functools, os, bson, requests, json, operator
...
def process_content(url: str) -> str:
    """Processes the content from a web page"""
...
system_prompt = (
    ...
    "determine which worker should take the next action. Each wprker is responsible for"
